...
#if defined(NDEBUG)
#error "Monk cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in uMONK) are considered zero fee (for relaying, mining and transaction creation)
