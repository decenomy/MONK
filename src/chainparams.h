...
#define __PORT_MAINNET__ 32270
#define __PORT_TESTNET__ 42270
#define __PORT_REGTEST__ 52270
 ...
 * Monk system. There are three: the main network on which people trade goods
